...
docker run --rm -it --name test-test -d -e VIRTUAL_HOST="test.oxiliatest.ydns.eu" -e LETSENCRYPT_HOST="test.oxiliatest.ydns.eu" -e VIRTUAL_PORT=80 --network nginx yeasy/simple-web:latest
